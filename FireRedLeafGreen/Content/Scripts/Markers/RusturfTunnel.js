...
markerSet(-191, 386, "Overworld", entrance, "Rusturf Tunnel");
markerSet(-201, 400, "Overworld", entrance, "Rusturf Tunnel");
markerSet(-197, 411, "Overworld", entrance, "Rusturf Tunnel");


markerSet(-181, 385, "Pokeball", itemIcon, "Rusturf Tunnel");
markerSet(-182, 412, "Max Ether", itemIcon, "Rusturf Tunnel");